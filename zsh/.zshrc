...
alias delete-node-modules='rm -rf node_modules/ packages/*/node_modules'
...
# pnpm
export PNPM_HOME="/Users/caiorosa/Library/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
...
# pnpm end
# bun completions
[ -s "/Users/caiorosa/.bun/_bun" ] && source "/Users/caiorosa/.bun/_bun"
...
export PATH="${KREW_ROOT:-$HOME/.krew}/bin:/sbin:${PATH}"
export PATH="/Users/caiorosa/Library/Python/3.11/bin:$PATH"
